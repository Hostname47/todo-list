        ...
        <div>
          ...
          <div className='dark'>
              <div className="align-center fs11" style={{ letterSpacing: '1.2px', gap: '2px' }}>
                  ...
                  <p className="unselectable bold no-margin">by<a href="https://mouad-nassri.netlify.app" target="_blank" className="no-underline" style={{ color: '#1993ff', marginLeft: '4px' }}>Mouad</a></p>
              </div>
          </div>
        </div>
      </div>
      <button className='button-style-1 move-to-right' onClick={ handleCreateTaskModalOpen }>
