...
import SquareButton from './styles/Button/SquareButton.styled'
  ...
  return (
    <div className="todo-item-container">
      ...
      <div className='operations-container'>
        ...
        <SquareButton title='Edit' onClick={ handleEditTaskModalOpen }>
        ...
        <SquareButton title='Delete' onClick={ e => handleDeleteContainer(e, true) }>
      ...
      <div className='content-box'>
        ...
        { displayNotes && (
          <div>
            { task.notes 
              ? <p className='notes'><strong>Notes :</strong> { task.notes }</p>
